...
namespace myDragModels
{
    ...
    addToRunTimeSelectionTable(myDragModel, GidaspowErgunWenYu, dictionary);
}
}
...
Foam::myDragModels::GidaspowErgunWenYu::GidaspowErgunWenYu
(
...
Foam::myDragModels::GidaspowErgunWenYu::CdRe() const
{
    return
