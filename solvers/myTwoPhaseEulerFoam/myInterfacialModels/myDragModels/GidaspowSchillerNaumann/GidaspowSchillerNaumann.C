...
namespace myDragModels
{
    ...
    addToRunTimeSelectionTable(myDragModel, GidaspowSchillerNaumann, dictionary);
}
}
...
Foam::myDragModels::GidaspowSchillerNaumann::GidaspowSchillerNaumann
(
...
Foam::myDragModels::GidaspowSchillerNaumann::CdRe() const
{
