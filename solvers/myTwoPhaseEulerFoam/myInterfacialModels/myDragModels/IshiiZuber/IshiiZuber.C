...
namespace myDragModels
{
    ...
    addToRunTimeSelectionTable(myDragModel, IshiiZuber, dictionary);
}
}
...
Foam::myDragModels::IshiiZuber::IshiiZuber
(
...
Foam::myDragModels::IshiiZuber::CdRe() const
{
...
// void Foam::myDragModels::IshiiZuber::FiSr() 
// {
//     volScalarField Re(pair_.Re());
//     volScalarField Eo(pair_.Eo());
// 
...
//     );
//     
//     fvMesh& mesh(pair_.phase1().mesh());
// 
//     volScalarField& FieldS = mesh.lookupObject<volScalarField>("FieldS");
//     volScalarField& FiSr = mesh.lookupObject<volScalarField>("FiSr");
//     volScalarField& FieldOmega = mesh.lookupObject<volScalarField>("FieldOmega");
//             
//     FieldS
//     (
