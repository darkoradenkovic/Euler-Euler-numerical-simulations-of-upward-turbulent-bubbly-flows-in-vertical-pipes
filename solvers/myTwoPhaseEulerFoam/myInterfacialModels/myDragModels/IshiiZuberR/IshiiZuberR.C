...
{
    defineTypeNameAndDebug(IshiiZuberR, 0);
    addToRunTimeSelectionTable(myDragModel, IshiiZuberR, dictionary);
}
}
...
Foam::myDragModels::IshiiZuberR::IshiiZuberR
(
...
Foam::myDragModels::IshiiZuberR::CdRe() const
{
    ...
    return
         (1.0+0.45*Sr)*(pos0(CdReEllipse - CdRe)
