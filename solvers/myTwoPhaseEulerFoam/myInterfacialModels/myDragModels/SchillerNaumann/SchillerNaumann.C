...
namespace myDragModels
{
    ...
    addToRunTimeSelectionTable(myDragModel, SchillerNaumann, dictionary);
}
}
...
Foam::myDragModels::SchillerNaumann::SchillerNaumann
(
...
Foam::tmp<Foam::volScalarField> Foam::myDragModels::SchillerNaumann::CdRe() const
{
