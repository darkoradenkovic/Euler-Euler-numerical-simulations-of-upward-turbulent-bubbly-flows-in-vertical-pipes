...
namespace myDragModels
{
    ...
    addToRunTimeSelectionTable(myDragModel, TomiyamaAnalytic, dictionary);
}
}
...
Foam::myDragModels::TomiyamaAnalytic::TomiyamaAnalytic
(
...
Foam::myDragModels::TomiyamaAnalytic::CdRe() const
{
