...
namespace myDragModels
{
    ...
    addToRunTimeSelectionTable(myDragModel, segregated, dictionary);
}
}
...
Foam::myDragModels::segregated::segregated
(
...
Foam::tmp<Foam::volScalarField> Foam::myDragModels::segregated::CdRe() const
{
...
Foam::tmp<Foam::volScalarField> Foam::myDragModels::segregated::K() const
{
...
Foam::tmp<Foam::surfaceScalarField> Foam::myDragModels::segregated::Kf() const
{
