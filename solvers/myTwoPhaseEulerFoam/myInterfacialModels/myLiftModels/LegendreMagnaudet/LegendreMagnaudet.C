...
namespace myLiftModels
{
    ...
    addToRunTimeSelectionTable(myLiftModel, LegendreMagnaudet, dictionary);
}
}
...
Foam::myLiftModels::LegendreMagnaudet::LegendreMagnaudet
(
...
Foam::tmp<Foam::volScalarField> Foam::myLiftModels::LegendreMagnaudet::Cl() const
{
