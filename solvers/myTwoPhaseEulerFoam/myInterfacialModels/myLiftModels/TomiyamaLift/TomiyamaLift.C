...
namespace myLiftModels
{
    ...
    addToRunTimeSelectionTable(myLiftModel, TomiyamaLift, dictionary);
}
}
...
Foam::myLiftModels::TomiyamaLift::TomiyamaLift
(
...
Foam::tmp<Foam::volScalarField> Foam::myLiftModels::TomiyamaLift::Cl() const
{
