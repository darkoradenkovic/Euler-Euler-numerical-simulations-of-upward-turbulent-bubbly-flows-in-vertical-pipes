...
namespace myVirtualMassModels
{
    ...
    addToRunTimeSelectionTable(myVirtualMassModel, noVirtualMass, dictionary);
}
}
...
Foam::myVirtualMassModels::noVirtualMass::noVirtualMass
(
...
Foam::myVirtualMassModels::noVirtualMass::Cvm() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::myVirtualMassModels::noVirtualMass::K() const
{
