...
Foam::autoPtr<Foam::myDiameterModels::IATEsource>
Foam::myDiameterModels::IATEsource::New
(
    const word& type,
    const IATE& iate,
...
Foam::tmp<Foam::volScalarField> Foam::myDiameterModels::IATEsource::Ur() const
{
...
Foam::tmp<Foam::volScalarField> Foam::myDiameterModels::IATEsource::Ut() const
{
    return sqrt(2*otherPhase().turbulence().k());
}


Foam::tmp<Foam::volScalarField> Foam::myDiameterModels::IATEsource::Re() const
{
    return max(Ur()*phase().d()/otherPhase().nu(), scalar(1.0e-3));
}


Foam::tmp<Foam::volScalarField> Foam::myDiameterModels::IATEsource::CD() const
{
...
Foam::tmp<Foam::volScalarField> Foam::myDiameterModels::IATEsource::Mo() const
{
    const uniformDimensionedVectorField& g =
        meshObjects::gravity::New(phase().U().time());
...
Foam::tmp<Foam::volScalarField> Foam::myDiameterModels::IATEsource::Eo() const
{
    const uniformDimensionedVectorField& g =
        meshObjects::gravity::New(phase().U().time());
...
Foam::tmp<Foam::volScalarField> Foam::myDiameterModels::IATEsource::We() const
{
