...
Foam::myDiameterModels::constant::constant
(
...
Foam::tmp<Foam::volScalarField> Foam::myDiameterModels::constant::d() const
{
...
bool Foam::myDiameterModels::constant::read(const dictionary& phaseProperties)
{
