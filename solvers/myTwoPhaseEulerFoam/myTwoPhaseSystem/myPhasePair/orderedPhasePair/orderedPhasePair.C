...
:
    myPhasePair(dispersed, continuous, g, sigmaTable, true)
{
    if (aspectRatioTable.found(*this))
    {
        aspectRatio_.reset
        (
            myAspectRatioModel::New
            (
...
const Foam::myPhaseModel& Foam::orderedPhasePair::dispersed() const
{
    return phase1();
}


const Foam::myPhaseModel& Foam::orderedPhasePair::continuous() const
{
    return phase2();
}
