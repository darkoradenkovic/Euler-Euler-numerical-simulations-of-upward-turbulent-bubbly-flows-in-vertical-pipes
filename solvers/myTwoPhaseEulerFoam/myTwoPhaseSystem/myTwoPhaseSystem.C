...
Foam::myTwoPhaseSystem::myTwoPhaseSystem
(
    const fvMesh& mesh,
    ...
    )
{
    ...
    myPhasePair::scalarTable sigmaTable(lookup("sigma"));
    myPhasePair::dictTable aspectRatioTable(lookup("aspectRatio"));
    ...
    drag_.set
    (
        new myBlendedInterfacialModel<myDragModel>
        (
            lookup("drag"),
            (
    ...
    virtualMass_.set
    (
        new myBlendedInterfacialModel<myVirtualMassModel>
        (
            lookup("virtualMass"),
            (
    ...
    lift_.set
    (
        new myBlendedInterfacialModel<myLiftModel>
        (
            lookup("lift"),
            (
    ...
    (
        new myBlendedInterfacialModel<myWallLubricationModel>
        (
    ...
    (
        new myBlendedInterfacialModel<myTurbulentDispersionModel>
        (
...
Foam::tmp<Foam::volScalarField> Foam::myTwoPhaseSystem::rho() const
{
    return phase1_*phase1_.thermo().rho() + phase2_*phase2_.thermo().rho();
}


Foam::tmp<Foam::volVectorField> Foam::myTwoPhaseSystem::U() const
{
    return phase1_*phase1_.U() + phase2_*phase2_.U();
}

Foam::tmp<Foam::volScalarField> Foam::myTwoPhaseSystem::magUr() const
{
    return mag(phase1_*phase1_.U() - phase2_*phase2_.U());
}

Foam::tmp<Foam::surfaceScalarField> Foam::myTwoPhaseSystem::calcPhi() const
{
    return
...
Foam::tmp<Foam::volScalarField> Foam::myTwoPhaseSystem::Kd() const
{
    return drag_->K();
}


Foam::tmp<Foam::surfaceScalarField> Foam::myTwoPhaseSystem::Kdf() const
{
    return drag_->Kf();
}


Foam::tmp<Foam::volScalarField> Foam::myTwoPhaseSystem::Vm() const
{
    return virtualMass_->K();
}


Foam::tmp<Foam::surfaceScalarField> Foam::myTwoPhaseSystem::Vmf() const
{
    return virtualMass_->Kf();
}


Foam::tmp<Foam::volVectorField> Foam::myTwoPhaseSystem::F() const
{
    return lift_->F<vector>() + wallLubrication_->F<vector>();
}

Foam::tmp<Foam::volVectorField> Foam::myTwoPhaseSystem::LiftForce() const
{
    return lift_->F<vector>();
}

Foam::tmp<Foam::volVectorField> Foam::myTwoPhaseSystem::WallLubricationForce() const
{
    return wallLubrication_->F<vector>();
}

Foam::tmp<Foam::surfaceScalarField> Foam::myTwoPhaseSystem::Ff() const
{
    return lift_->Ff() + wallLubrication_->Ff();
}

Foam::tmp<Foam::volScalarField> Foam::myTwoPhaseSystem::D() const
{
    return turbulentDispersion_->D();
}

Foam::tmp<Foam::volScalarField> Foam::myTwoPhaseSystem::DLam() const
{
    return turbulentDispersion_->DLam();
}

Foam::tmp<Foam::volVectorField> Foam::myTwoPhaseSystem::LamPlusTurbDispForce() const
{
    return turbulentDispersion_->F<vector>();
}

Foam::tmp<Foam::volVectorField> Foam::myTwoPhaseSystem::LamDispForce() const
{
    return turbulentDispersion_->FLam<vector>();
}

Foam::tmp<Foam::volVectorField> Foam::myTwoPhaseSystem::TurbDispForce() const
{
    return turbulentDispersion_->FTurb<vector>();
}


void Foam::myTwoPhaseSystem::solve()
{
...
void Foam::myTwoPhaseSystem::correct()
{
    phase1_.correct();
    phase2_.correct();
}
...
void Foam::myTwoPhaseSystem::correctTurbulence()
{
...
bool Foam::myTwoPhaseSystem::read()
{
    if (regIOobject::read())
    {
        bool readOK = true;
...
const Foam::dimensionedScalar& Foam::myTwoPhaseSystem::sigma() const
{
    return pair_->sigma();
}
