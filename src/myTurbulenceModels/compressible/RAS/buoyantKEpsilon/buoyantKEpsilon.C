...
buoyantKEpsilon<BasicMyTurbulenceModel>::buoyantKEpsilon
(
...
template<class BasicMyTurbulenceModel>
bool buoyantKEpsilon<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField>
buoyantKEpsilon<BasicMyTurbulenceModel>::Gcoef() const
{
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix>
buoyantKEpsilon<BasicMyTurbulenceModel>::kSource() const
{
    const uniformDimensionedVectorField& g =
        meshObjects::gravity::New(this->mesh_.time());
    ...
    return kEpsilon<BasicMyTurbulenceModel>::kSource();
}


template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix>
buoyantKEpsilon<BasicMyTurbulenceModel>::epsilonSource() const
{
    const uniformDimensionedVectorField& g =
        meshObjects::gravity::New(this->mesh_.time());
    ...
    return kEpsilon<BasicMyTurbulenceModel>::epsilonSource();
}
