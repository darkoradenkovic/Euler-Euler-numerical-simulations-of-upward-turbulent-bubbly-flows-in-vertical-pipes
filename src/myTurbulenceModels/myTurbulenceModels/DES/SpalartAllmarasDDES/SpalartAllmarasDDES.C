...
tmp<volScalarField> SpalartAllmarasDDES<BasicMyTurbulenceModel>::rd
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDDES<BasicMyTurbulenceModel>::fd
(
    const volScalarField& magGradU
) const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDDES<BasicMyTurbulenceModel>::dTilda
(
...
template<class BasicMyTurbulenceModel>
SpalartAllmarasDDES<BasicMyTurbulenceModel>::SpalartAllmarasDDES
(
...
template<class BasicMyTurbulenceModel>
bool SpalartAllmarasDDES<BasicMyTurbulenceModel>::read()
{
