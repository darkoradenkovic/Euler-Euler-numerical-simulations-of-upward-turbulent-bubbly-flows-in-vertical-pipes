...
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::chi() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::fv1
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::fv2
(
    const volScalarField& chi,
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::ft2
(
    const volScalarField& chi
) const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::Omega
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::Stilda
(
    const volScalarField& chi,
    const volScalarField& fv1,
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::r
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::fw
(
    const volScalarField& Omega,
    const volScalarField& dTilda
) const
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::psi
(
    const volScalarField& chi,
    const volScalarField& fv1
) const
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::dTilda
(
    const volScalarField& chi,
    const volScalarField& fv1,
    const volTensorField& gradU
...
template<class BasicMyTurbulenceModel>
void SpalartAllmarasDES<BasicMyTurbulenceModel>::correctNut
(
    const volScalarField& fv1
)
{
...
template<class BasicMyTurbulenceModel>
SpalartAllmarasDES<BasicMyTurbulenceModel>::SpalartAllmarasDES
(
...
:
    DESModel<BasicMyTurbulenceModel>
    (
        type,
        alpha,
        rho,
...
template<class BasicMyTurbulenceModel>
bool SpalartAllmarasDES<BasicMyTurbulenceModel>::read()
{
    if (DESModel<BasicMyTurbulenceModel>::read())
    {
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::
DnuTildaEff() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::k() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmarasDES<BasicMyTurbulenceModel>::LESRegion() const
{
    const volScalarField chi(this->chi());
    const volScalarField fv1(this->fv1(chi));
...
template<class BasicMyTurbulenceModel>
void SpalartAllmarasDES<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    DESModel<BasicMyTurbulenceModel>::correct();
