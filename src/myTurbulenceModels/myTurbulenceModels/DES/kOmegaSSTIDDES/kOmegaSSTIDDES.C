...
const IDDESDelta& kOmegaSSTIDDES<BasicMyTurbulenceModel>::setDelta() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMyTurbulenceModel>::alpha() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMyTurbulenceModel>::ft
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMyTurbulenceModel>::fl
(
    const volScalarField& magGradU
) const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMyTurbulenceModel>::rd
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMyTurbulenceModel>::fdt
(
    const volScalarField& magGradU
) const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> kOmegaSSTIDDES<BasicMyTurbulenceModel>::dTilda
(
    const volScalarField& magGradU,
...
template<class BasicMyTurbulenceModel>
kOmegaSSTIDDES<BasicMyTurbulenceModel>::kOmegaSSTIDDES
(
...
:
    kOmegaSSTDES<BasicMyTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicMyTurbulenceModel>
bool kOmegaSSTIDDES<BasicMyTurbulenceModel>::read()
{
    if (kOmegaSSTDES<BasicMyTurbulenceModel>::read())
    {
