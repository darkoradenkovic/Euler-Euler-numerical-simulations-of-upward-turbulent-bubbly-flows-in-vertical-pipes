...
void DeardorffDiffStress<BasicMyTurbulenceModel>::correctNut()
{
...
template<class BasicMyTurbulenceModel>
DeardorffDiffStress<BasicMyTurbulenceModel>::DeardorffDiffStress
(
...
:
    ReynoldsStress<LESModel<BasicMyTurbulenceModel>>
    (
        type,
        alpha,
        rho,
...
template<class BasicMyTurbulenceModel>
bool DeardorffDiffStress<BasicMyTurbulenceModel>::read()
{
    if (ReynoldsStress<LESModel<BasicMyTurbulenceModel>>::read())
    {
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> DeardorffDiffStress<BasicMyTurbulenceModel>::epsilon() const
{
...
template<class BasicMyTurbulenceModel>
void DeardorffDiffStress<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    ReynoldsStress<LESModel<BasicMyTurbulenceModel>>::correct();
