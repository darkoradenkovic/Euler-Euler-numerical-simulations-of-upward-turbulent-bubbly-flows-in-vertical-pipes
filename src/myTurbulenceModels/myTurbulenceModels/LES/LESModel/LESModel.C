...
void Foam::LESModel<BasicMyTurbulenceModel>::printCoeffs(const word& type)
{
    if (printCoeffs_)
    {
...
template<class BasicMyTurbulenceModel>
Foam::LESModel<BasicMyTurbulenceModel>::LESModel
(
    const word& type,
...
template<class BasicMyTurbulenceModel>
Foam::autoPtr<Foam::LESModel<BasicMyTurbulenceModel>>
Foam::LESModel<BasicMyTurbulenceModel>::New
(
    const alphaField& alpha,
    const rhoField& rho,
    const volVectorField& U,
...
template<class BasicMyTurbulenceModel>
bool Foam::LESModel<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void Foam::LESModel<BasicMyTurbulenceModel>::correct()
{
    delta_().correct();
