...
volScalarField dynamicKEqn<BasicMyTurbulenceModel>::Ck
(
...
template<class BasicMyTurbulenceModel>
volScalarField dynamicKEqn<BasicMyTurbulenceModel>::Ce
(
    const volSymmTensorField& D,
    const volScalarField& KK
) const
...
template<class BasicMyTurbulenceModel>
volScalarField dynamicKEqn<BasicMyTurbulenceModel>::Ce() const
{
...
template<class BasicMyTurbulenceModel>
void dynamicKEqn<BasicMyTurbulenceModel>::correctNut
(
    const volSymmTensorField& D,
    const volScalarField& KK
)
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> dynamicKEqn<BasicMyTurbulenceModel>::kSource() const
{
...
template<class BasicMyTurbulenceModel>
dynamicKEqn<BasicMyTurbulenceModel>::dynamicKEqn
(
...
:
    LESeddyViscosity<BasicMyTurbulenceModel>
    (
        type,
        alpha,
        rho,
...
template<class BasicMyTurbulenceModel>
bool dynamicKEqn<BasicMyTurbulenceModel>::read()
{
    if (LESeddyViscosity<BasicMyTurbulenceModel>::read())
    {
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> dynamicKEqn<BasicMyTurbulenceModel>::epsilon() const
{
...
template<class BasicMyTurbulenceModel>
void dynamicKEqn<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    LESeddyViscosity<BasicMyTurbulenceModel>::correct();
