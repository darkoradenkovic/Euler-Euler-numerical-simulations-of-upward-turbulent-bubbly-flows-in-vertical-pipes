...
void dynamicLagrangian<BasicMyTurbulenceModel>::correctNut
(
...
template<class BasicMyTurbulenceModel>
dynamicLagrangian<BasicMyTurbulenceModel>::dynamicLagrangian
(
...
template<class BasicMyTurbulenceModel>
bool dynamicLagrangian<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void dynamicLagrangian<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
