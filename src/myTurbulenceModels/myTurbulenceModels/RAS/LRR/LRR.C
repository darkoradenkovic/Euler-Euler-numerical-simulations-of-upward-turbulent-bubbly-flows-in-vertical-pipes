...
void LRR<BasicMyTurbulenceModel>::correctNut()
{
...
template<class BasicMyTurbulenceModel>
LRR<BasicMyTurbulenceModel>::LRR
(
...
template<class BasicMyTurbulenceModel>
bool LRR<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
tmp<volSymmTensorField> LRR<BasicMyTurbulenceModel>::DREff() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volSymmTensorField> LRR<BasicMyTurbulenceModel>::DepsilonEff() const
{
    return tmp<volSymmTensorField>
    (
        new volSymmTensorField
...
template<class BasicMyTurbulenceModel>
void LRR<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
