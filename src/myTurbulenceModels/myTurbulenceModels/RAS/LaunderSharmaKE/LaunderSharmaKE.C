...
tmp<volScalarField> LaunderSharmaKE<BasicMyTurbulenceModel>::fMu() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> LaunderSharmaKE<BasicMyTurbulenceModel>::f2() const
{
    return
        scalar(1)
...
template<class BasicMyTurbulenceModel>
void LaunderSharmaKE<BasicMyTurbulenceModel>::correctNut()
{
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> LaunderSharmaKE<BasicMyTurbulenceModel>::kSource() const
{
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> LaunderSharmaKE<BasicMyTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMyTurbulenceModel>
LaunderSharmaKE<BasicMyTurbulenceModel>::LaunderSharmaKE
(
...
template<class BasicMyTurbulenceModel>
bool LaunderSharmaKE<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void LaunderSharmaKE<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
