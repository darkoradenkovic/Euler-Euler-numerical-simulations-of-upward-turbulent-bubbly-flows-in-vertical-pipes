...
tmp<volScalarField> LaunderSharmaKECF<BasicMyTurbulenceModel>::fMu() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> LaunderSharmaKECF<BasicMyTurbulenceModel>::f2() const
{
    return
        scalar(1)
...
template<class BasicMyTurbulenceModel>
void LaunderSharmaKECF<BasicMyTurbulenceModel>::correctNut()
{
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> LaunderSharmaKECF<BasicMyTurbulenceModel>::kSource() const
{
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> LaunderSharmaKECF<BasicMyTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMyTurbulenceModel>
LaunderSharmaKECF<BasicMyTurbulenceModel>::LaunderSharmaKECF
(
...
template<class BasicMyTurbulenceModel>
bool LaunderSharmaKECF<BasicMyTurbulenceModel>::read()
{
    if (eddyViscosity<RASModel<BasicMyTurbulenceModel>>::read())
    {
        ...
        kBI_.readIfPresent(this->coeffDict());
        cEpsB_.readIfPresent(this->coeffDict());
        return true;
    }
...
template<class BasicMyTurbulenceModel>
void LaunderSharmaKECF<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
   ...
   const volScalarField& dB =
    ...
    volScalarField Sk = kBI_*fi&URel;
    volScalarField Sepsilon = cEpsB_*Sk/(dB/(sqrt(k_)));
