...
void Foam::RASModel<BasicMyTurbulenceModel>::printCoeffs(const word& type)
{
    if (printCoeffs_)
    {
...
template<class BasicMyTurbulenceModel>
Foam::RASModel<BasicMyTurbulenceModel>::RASModel
(
    const word& type,
...
template<class BasicMyTurbulenceModel>
Foam::autoPtr<Foam::RASModel<BasicMyTurbulenceModel>>
Foam::RASModel<BasicMyTurbulenceModel>::New
(
    const alphaField& alpha,
    const rhoField& rho,
    const volVectorField& U,
...
template<class BasicMyTurbulenceModel>
bool Foam::RASModel<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void Foam::RASModel<BasicMyTurbulenceModel>::correct()
{
