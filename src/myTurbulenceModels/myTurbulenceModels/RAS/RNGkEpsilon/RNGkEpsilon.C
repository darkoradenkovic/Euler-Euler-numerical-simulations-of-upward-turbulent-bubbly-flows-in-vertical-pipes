...
void RNGkEpsilon<BasicMyTurbulenceModel>::correctNut()
{
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> RNGkEpsilon<BasicMyTurbulenceModel>::kSource() const
{
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> RNGkEpsilon<BasicMyTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMyTurbulenceModel>
RNGkEpsilon<BasicMyTurbulenceModel>::RNGkEpsilon
(
...
template<class BasicMyTurbulenceModel>
bool RNGkEpsilon<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void RNGkEpsilon<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
