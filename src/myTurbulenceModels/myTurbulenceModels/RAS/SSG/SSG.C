...
void SSG<BasicMyTurbulenceModel>::correctNut()
{
...
template<class BasicMyTurbulenceModel>
SSG<BasicMyTurbulenceModel>::SSG
(
...
template<class BasicMyTurbulenceModel>
bool SSG<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
tmp<volSymmTensorField> SSG<BasicMyTurbulenceModel>::DREff() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volSymmTensorField> SSG<BasicMyTurbulenceModel>::DepsilonEff() const
{
    return tmp<volSymmTensorField>
    (
        new volSymmTensorField
...
template<class BasicMyTurbulenceModel>
void SSG<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
