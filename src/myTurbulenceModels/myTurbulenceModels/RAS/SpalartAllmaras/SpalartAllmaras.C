...
tmp<volScalarField> SpalartAllmaras<BasicMyTurbulenceModel>::chi() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmaras<BasicMyTurbulenceModel>::fv1
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmaras<BasicMyTurbulenceModel>::fv2
(
    const volScalarField& chi,
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmaras<BasicMyTurbulenceModel>::Stilda
(
    const volScalarField& chi,
    const volScalarField& fv1
) const
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmaras<BasicMyTurbulenceModel>::fw
(
...
template<class BasicMyTurbulenceModel>
void SpalartAllmaras<BasicMyTurbulenceModel>::correctNut
(
    const volScalarField& fv1
)
{
...
template<class BasicMyTurbulenceModel>
SpalartAllmaras<BasicMyTurbulenceModel>::SpalartAllmaras
(
...
template<class BasicMyTurbulenceModel>
bool SpalartAllmaras<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmaras<BasicMyTurbulenceModel>::DnuTildaEff() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmaras<BasicMyTurbulenceModel>::k() const
{
    WarningInFunction
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> SpalartAllmaras<BasicMyTurbulenceModel>::epsilon() const
{
    WarningInFunction
...
template<class BasicMyTurbulenceModel>
void SpalartAllmaras<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
