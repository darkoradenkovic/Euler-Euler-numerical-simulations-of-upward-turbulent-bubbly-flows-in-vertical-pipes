...
void kOmega<BasicMyTurbulenceModel>::correctNut()
{
    this->nut_ = k_/omega_;
...
template<class BasicMyTurbulenceModel>
kOmega<BasicMyTurbulenceModel>::kOmega
(
...
template<class BasicMyTurbulenceModel>
bool kOmega<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void kOmega<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
