...
tmp<volScalarField> kOmegaSSTLM<BasicMyTurbulenceModel>::F1
(
...
) const
{
    ...
    return max(kOmegaSST<BasicMyTurbulenceModel>::F1(CDkOmega), F3);
}


template<class BasicMyTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM<BasicMyTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSST<BasicMyTurbulenceModel>::Pk(G);
}


template<class BasicMyTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM<BasicMyTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *kOmegaSST<BasicMyTurbulenceModel>::epsilonByk(F1, gradU);
}


template<class BasicMyTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM<BasicMyTurbulenceModel>::Fthetat
(
...
kOmegaSSTLM<BasicMyTurbulenceModel>::ReThetac() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM<BasicMyTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM<BasicMyTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM<BasicMyTurbulenceModel>::Fonset
(
...
template<class BasicMyTurbulenceModel>
kOmegaSSTLM<BasicMyTurbulenceModel>::kOmegaSSTLM
(
...
template<class BasicMyTurbulenceModel>
bool kOmegaSSTLM<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void kOmegaSSTLM<BasicMyTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicMyTurbulenceModel>
void kOmegaSSTLM<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
