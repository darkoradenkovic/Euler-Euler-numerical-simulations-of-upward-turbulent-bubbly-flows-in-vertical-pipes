...
tmp<fvScalarMatrix> kOmegaSSTSAS<BasicMyTurbulenceModel>::Qsas
(
...
template<class BasicMyTurbulenceModel>
kOmegaSSTSAS<BasicMyTurbulenceModel>::kOmegaSSTSAS
(
...
template<class BasicMyTurbulenceModel>
bool kOmegaSSTSAS<BasicMyTurbulenceModel>::read()
{
