...
tmp<volScalarField> v2f<BasicMyTurbulenceModel>::Ts() const
{
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> v2f<BasicMyTurbulenceModel>::Ls() const
{
    // SAF: limiting thermo->nu(). If psiThermo is used rho might be < 0
    // temporarily when p < 0 then nu < 0 which needs limiting
    return
...
template<class BasicMyTurbulenceModel>
void v2f<BasicMyTurbulenceModel>::correctNut()
{
...
template<class BasicMyTurbulenceModel>
v2f<BasicMyTurbulenceModel>::v2f
(
...
template<class BasicMyTurbulenceModel>
bool v2f<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void v2f<BasicMyTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
