...
Foam::scalar Foam::myEpsilonWallFunctionFvPatchScalarField::tolerance_ = 1e-5;
...
void Foam::myEpsilonWallFunctionFvPatchScalarField::writeLocalEntries
(
    Ostream& os
) const
{
...
void Foam::myEpsilonWallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1)
    {
        return;
    ...
    forAll(bf, patchi)
    {
        if (isA<myEpsilonWallFunctionFvPatchScalarField>(bf[patchi]))
        {
            myEpsilonWallFunctionFvPatchScalarField& epf = epsilonPatch(patchi);
...
void Foam::myEpsilonWallFunctionFvPatchScalarField::createAveragingWeights()
{
    const volScalarField& epsilon =
        static_cast<const volScalarField&>(this->internalField());
...
Foam::myEpsilonWallFunctionFvPatchScalarField::epsilonPatch(const label patchi)
{
    const volScalarField& epsilon =
        static_cast<const volScalarField&>(this->internalField());
    ...
    const myEpsilonWallFunctionFvPatchScalarField& epf =
        refCast<const myEpsilonWallFunctionFvPatchScalarField>(bf[patchi]);

    return const_cast<myEpsilonWallFunctionFvPatchScalarField&>(epf);
}


void Foam::myEpsilonWallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void Foam::myEpsilonWallFunctionFvPatchScalarField::calculate
(
...
myEpsilonWallFunctionFvPatchScalarField
(
    const myEpsilonWallFunctionFvPatchScalarField& ewfpsf
)
:
...
Foam::scalarField& Foam::myEpsilonWallFunctionFvPatchScalarField::G(bool init)
{
...
Foam::scalarField& Foam::myEpsilonWallFunctionFvPatchScalarField::epsilon
(
    bool init
)
{
...
void Foam::myEpsilonWallFunctionFvPatchScalarField::updateWeightedCoeffs
(
...
void Foam::myEpsilonWallFunctionFvPatchScalarField::manipulateMatrix
(
