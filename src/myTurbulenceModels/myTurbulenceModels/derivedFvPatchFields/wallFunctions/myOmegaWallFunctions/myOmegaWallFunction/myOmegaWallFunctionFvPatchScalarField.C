...
#include "myOmegaWallFunctionFvPatchScalarField.H"
...
scalar myOmegaWallFunctionFvPatchScalarField::tolerance_ = 1e-5;

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void myOmegaWallFunctionFvPatchScalarField::checkType()
{
...
void myOmegaWallFunctionFvPatchScalarField::writeLocalEntries(Ostream& os) const
{
...
void myOmegaWallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1)
    {
        return;
    ...
    forAll(bf, patchi)
    {
        if (isA<myOmegaWallFunctionFvPatchScalarField>(bf[patchi]))
        {
            myOmegaWallFunctionFvPatchScalarField& opf = omegaPatch(patchi);
...
void myOmegaWallFunctionFvPatchScalarField::createAveragingWeights()
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->internalField());
...
myOmegaWallFunctionFvPatchScalarField::omegaPatch(const label patchi)
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->internalField());
    ...
    const myOmegaWallFunctionFvPatchScalarField& opf =
        refCast<const myOmegaWallFunctionFvPatchScalarField>(bf[patchi]);

    return const_cast<myOmegaWallFunctionFvPatchScalarField&>(opf);
}


void myOmegaWallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void myOmegaWallFunctionFvPatchScalarField::calculate
(
    const myTurbulenceModel& turbModel,
...
myOmegaWallFunctionFvPatchScalarField::myOmegaWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
myOmegaWallFunctionFvPatchScalarField::myOmegaWallFunctionFvPatchScalarField
(
    const myOmegaWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
myOmegaWallFunctionFvPatchScalarField::myOmegaWallFunctionFvPatchScalarField
(
    const myOmegaWallFunctionFvPatchScalarField& owfpsf
)
:
...
scalarField& myOmegaWallFunctionFvPatchScalarField::G(bool init)
{
...
scalarField& myOmegaWallFunctionFvPatchScalarField::omega(bool init)
{
    if (patch().index() == master_)
    {
        if (init)
...
void myOmegaWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void myOmegaWallFunctionFvPatchScalarField::updateWeightedCoeffs
(
...
void myOmegaWallFunctionFvPatchScalarField::manipulateMatrix
(
...
void myOmegaWallFunctionFvPatchScalarField::write(Ostream& os) const
{
