...
Foam::eddyViscosity<BasicMyTurbulenceModel>::eddyViscosity
(
    const word& type,
...
:
    linearViscousStress<BasicMyTurbulenceModel>
    (
        type,
        alpha,
        rho,
...
template<class BasicMyTurbulenceModel>
bool Foam::eddyViscosity<BasicMyTurbulenceModel>::read()
{
...
Foam::eddyViscosity<BasicMyTurbulenceModel>::R() const
{
...
template<class BasicMyTurbulenceModel>
void Foam::eddyViscosity<BasicMyTurbulenceModel>::validate()
{
    correctNut();
}
...
template<class BasicMyTurbulenceModel>
void Foam::eddyViscosity<BasicMyTurbulenceModel>::correct()
{
