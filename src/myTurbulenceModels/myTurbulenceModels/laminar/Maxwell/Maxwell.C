...
Maxwell<BasicMyTurbulenceModel>::Maxwell
(
...
:
    laminarModel<BasicMyTurbulenceModel>
    (
        type,
        alpha,
        rho,
...
template<class BasicMyTurbulenceModel>
bool Maxwell<BasicMyTurbulenceModel>::read()
{
    if (laminarModel<BasicMyTurbulenceModel>::read())
    {
...
Maxwell<BasicMyTurbulenceModel>::R() const
{
    return sigma_;
}
...
template<class BasicMyTurbulenceModel>
tmp<Foam::volSymmTensorField>
Maxwell<BasicMyTurbulenceModel>::devRhoReff() const
{
...
Maxwell<BasicMyTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
...
template<class BasicMyTurbulenceModel>
void Maxwell<BasicMyTurbulenceModel>::correct()
{
    // Local references
