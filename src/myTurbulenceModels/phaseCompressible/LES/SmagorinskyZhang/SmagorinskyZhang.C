...
SmagorinskyZhang<BasicMyTurbulenceModel>::SmagorinskyZhang
(
...
:
    Smagorinsky<BasicMyTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicMyTurbulenceModel>
bool SmagorinskyZhang<BasicMyTurbulenceModel>::read()
{
    if (Smagorinsky<BasicMyTurbulenceModel>::read())
    {
...
>&
SmagorinskyZhang<BasicMyTurbulenceModel>::gasTurbulence() const
{
...
template<class BasicMyTurbulenceModel>
void SmagorinskyZhang<BasicMyTurbulenceModel>::correctNut()
{
