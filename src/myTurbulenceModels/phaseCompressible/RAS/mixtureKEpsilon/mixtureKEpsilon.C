...
mixtureKEpsilon<BasicMyTurbulenceModel>::mixtureKEpsilon
(
...
template<class BasicMyTurbulenceModel>
wordList mixtureKEpsilon<BasicMyTurbulenceModel>::epsilonBoundaryTypes
(
...
template<class BasicMyTurbulenceModel>
void mixtureKEpsilon<BasicMyTurbulenceModel>::correctInletOutlet
(
    volScalarField& vsf,
...
template<class BasicMyTurbulenceModel>
void mixtureKEpsilon<BasicMyTurbulenceModel>::initMixtureFields()
{
    ...
    mixtureKEpsilon<BasicMyTurbulenceModel>& turbc = this->liquidTurbulence();
...
template<class BasicMyTurbulenceModel>
bool mixtureKEpsilon<BasicMyTurbulenceModel>::read()
{
...
template<class BasicMyTurbulenceModel>
void mixtureKEpsilon<BasicMyTurbulenceModel>::correctNut()
{
...
template<class BasicMyTurbulenceModel>
mixtureKEpsilon<BasicMyTurbulenceModel>&
mixtureKEpsilon<BasicMyTurbulenceModel>::liquidTurbulence() const
{
    if (!liquidTurbulencePtr_)
    {
        ...
        liquidTurbulencePtr_ =
           &const_cast<mixtureKEpsilon<BasicMyTurbulenceModel>&>
            (
                U.db().lookupObject<mixtureKEpsilon<BasicMyTurbulenceModel>>
                (
                    IOobject::groupName
                    (
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> mixtureKEpsilon<BasicMyTurbulenceModel>::Ct2() const
{
    const mixtureKEpsilon<BasicMyTurbulenceModel>& liquidTurbulence =
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> mixtureKEpsilon<BasicMyTurbulenceModel>::rholEff() const
{
    const transportModel& gas = this->transport();
    const myTwoPhaseSystem& fluid = refCast<const myTwoPhaseSystem>(gas.fluid());
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> mixtureKEpsilon<BasicMyTurbulenceModel>::rhogEff() const
{
    const transportModel& gas = this->transport();
    const myTwoPhaseSystem& fluid = refCast<const myTwoPhaseSystem>(gas.fluid());
    const myVirtualMassModel& virtualMass =
        fluid.lookupSubModel<myVirtualMassModel>(gas, fluid.otherPhase(gas));
    return
        gas.rho()
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> mixtureKEpsilon<BasicMyTurbulenceModel>::rhom() const
{
    const volScalarField& alphag = this->alpha_;
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> mixtureKEpsilon<BasicMyTurbulenceModel>::mix
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> mixtureKEpsilon<BasicMyTurbulenceModel>::mixU
(
    const volScalarField& fc,
    const volScalarField& fd
) const
...
template<class BasicMyTurbulenceModel>
tmp<surfaceScalarField> mixtureKEpsilon<BasicMyTurbulenceModel>::mixFlux
(
...
template<class BasicMyTurbulenceModel>
tmp<volScalarField> mixtureKEpsilon<BasicMyTurbulenceModel>::bubbleG() const
{
    const mixtureKEpsilon<BasicMyTurbulenceModel>& liquidTurbulence =
        this->liquidTurbulence();
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> mixtureKEpsilon<BasicMyTurbulenceModel>::kSource() const
{
...
template<class BasicMyTurbulenceModel>
tmp<fvScalarMatrix> mixtureKEpsilon<BasicMyTurbulenceModel>::epsilonSource() const
{
...
template<class BasicMyTurbulenceModel>
void mixtureKEpsilon<BasicMyTurbulenceModel>::correct()
{
    const transportModel& gas = this->transport();
    const myTwoPhaseSystem& fluid = refCast<const myTwoPhaseSystem>(gas.fluid());
    ...
    // Local references to liquid-phase properties
    mixtureKEpsilon<BasicMyTurbulenceModel>& liquidTurbulence =
        this->liquidTurbulence();
